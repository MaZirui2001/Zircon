...
module RF_EX_Reg_1(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inst_pack_reg_alu_op <= io_flush ? 5'h0 : io_inst_pack_RF_alu_op;
      inst_pack_reg_alu_rs1_sel <= io_flush ? 2'h0 : io_inst_pack_RF_alu_rs1_sel;
      inst_pack_reg_alu_rs2_sel <= io_flush ? 2'h0 : io_inst_pack_RF_alu_rs2_sel;
      inst_pack_reg_pc <= io_flush ? 32'h0 : io_inst_pack_RF_pc;
      inst_pack_reg_br_type <= io_flush ? 4'h0 : io_inst_pack_RF_br_type;
      inst_pack_reg_predict_jump <= ~io_flush & io_inst_pack_RF_predict_jump;
      inst_pack_reg_pred_npc <= io_flush ? 32'h0 : io_inst_pack_RF_pred_npc;
