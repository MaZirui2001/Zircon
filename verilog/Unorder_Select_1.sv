...
module Unorder_Select_1(
  ...
  always_comb begin
    casez (select_index)
      3'b000:
        casez_tmp_5 = io_insts_issue_0_inst_alu_op;
      3'b001:
        casez_tmp_5 = io_insts_issue_1_inst_alu_op;
      3'b010:
        casez_tmp_5 = io_insts_issue_2_inst_alu_op;
      3'b011:
        casez_tmp_5 = io_insts_issue_3_inst_alu_op;
      3'b100:
        casez_tmp_5 = io_insts_issue_4_inst_alu_op;
      3'b101:
        casez_tmp_5 = io_insts_issue_5_inst_alu_op;
      3'b110:
        casez_tmp_5 = io_insts_issue_6_inst_alu_op;
      default:
        casez_tmp_5 = io_insts_issue_7_inst_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (select_index)
      3'b000:
        casez_tmp_6 = io_insts_issue_0_inst_alu_rs1_sel;
      3'b001:
        casez_tmp_6 = io_insts_issue_1_inst_alu_rs1_sel;
      3'b010:
        casez_tmp_6 = io_insts_issue_2_inst_alu_rs1_sel;
      3'b011:
        casez_tmp_6 = io_insts_issue_3_inst_alu_rs1_sel;
      3'b100:
        casez_tmp_6 = io_insts_issue_4_inst_alu_rs1_sel;
      3'b101:
        casez_tmp_6 = io_insts_issue_5_inst_alu_rs1_sel;
      3'b110:
        casez_tmp_6 = io_insts_issue_6_inst_alu_rs1_sel;
      default:
        casez_tmp_6 = io_insts_issue_7_inst_alu_rs1_sel;
    endcase
  end // always_comb
  always_comb begin
    casez (select_index)
      3'b000:
        casez_tmp_7 = io_insts_issue_0_inst_alu_rs2_sel;
      3'b001:
        casez_tmp_7 = io_insts_issue_1_inst_alu_rs2_sel;
      3'b010:
        casez_tmp_7 = io_insts_issue_2_inst_alu_rs2_sel;
      3'b011:
        casez_tmp_7 = io_insts_issue_3_inst_alu_rs2_sel;
      3'b100:
        casez_tmp_7 = io_insts_issue_4_inst_alu_rs2_sel;
      3'b101:
        casez_tmp_7 = io_insts_issue_5_inst_alu_rs2_sel;
      3'b110:
        casez_tmp_7 = io_insts_issue_6_inst_alu_rs2_sel;
      default:
        casez_tmp_7 = io_insts_issue_7_inst_alu_rs2_sel;
    endcase
  end // always_comb
  always_comb begin
    casez (select_index)
  ...
  always_comb begin
    casez (select_index)
      3'b000:
        casez_tmp_9 = io_insts_issue_0_inst_br_type;
      3'b001:
        casez_tmp_9 = io_insts_issue_1_inst_br_type;
      3'b010:
        casez_tmp_9 = io_insts_issue_2_inst_br_type;
      3'b011:
        casez_tmp_9 = io_insts_issue_3_inst_br_type;
      3'b100:
        casez_tmp_9 = io_insts_issue_4_inst_br_type;
      3'b101:
        casez_tmp_9 = io_insts_issue_5_inst_br_type;
      3'b110:
        casez_tmp_9 = io_insts_issue_6_inst_br_type;
      default:
        casez_tmp_9 = io_insts_issue_7_inst_br_type;
    endcase
  end // always_comb
  always_comb begin
    casez (select_index)
  ...
  assign io_inst_issue_inst_br_type = _io_inst_issue_T_6 ? casez_tmp_9 : 4'h0;
  assign io_inst_issue_inst_predict_jump = _io_inst_issue_T_6 & casez_tmp_10;
  assign io_inst_issue_inst_pred_npc = _io_inst_issue_T_6 ? casez_tmp_11 : 32'h0;
