...
module Prev_Decode(
  ...
  wire        inst_pack_pd_3_predict_jump;
  ...
  wire        pred_fix_0 =
    io_insts_pack_IF_0_inst_valid & ~io_insts_pack_IF_0_predict_jump
    & inst_pack_pd_0_predict_jump;
  wire        pred_fix_1 =
    io_insts_pack_IF_1_inst_valid & ~io_insts_pack_IF_1_predict_jump
    & inst_pack_pd_1_predict_jump;
  wire        pred_fix_2 =
    io_insts_pack_IF_2_inst_valid & ~io_insts_pack_IF_2_predict_jump
    & inst_pack_pd_2_predict_jump;
  ...
  wire        _GEN_3 = ~io_insts_pack_IF_0_pred_valid & io_insts_pack_IF_0_inst_valid;
  wire        _GEN_4 = jump_type_0 == 2'h1;
  wire        _GEN_5 = jump_type_0 == 2'h2;
  assign inst_pack_pd_0_predict_jump =
    _GEN_3
      ? _GEN_4 | (_GEN_5 ? io_insts_pack_IF_0_inst[25] : io_insts_pack_IF_0_predict_jump)
      : io_insts_pack_IF_0_predict_jump;
  assign inst_pack_pd_0_pred_npc =
    _GEN_3
      ...
      : io_insts_pack_IF_0_pred_npc;
  wire        _GEN_6 = ~io_insts_pack_IF_1_pred_valid & io_insts_pack_IF_1_inst_valid;
  wire        _GEN_7 = jump_type_1 == 2'h1;
  wire        _GEN_8 = jump_type_1 == 2'h2;
  assign inst_pack_pd_1_predict_jump =
    _GEN_6
      ? _GEN_7 | (_GEN_8 ? io_insts_pack_IF_1_inst[25] : io_insts_pack_IF_1_predict_jump)
      : io_insts_pack_IF_1_predict_jump;
  assign inst_pack_pd_1_pred_npc =
    _GEN_6
      ...
      : io_insts_pack_IF_1_pred_npc;
  wire        _GEN_9 = ~io_insts_pack_IF_2_pred_valid & io_insts_pack_IF_2_inst_valid;
  wire        _GEN_10 = jump_type_2 == 2'h1;
  wire        _GEN_11 = jump_type_2 == 2'h2;
  assign inst_pack_pd_2_predict_jump =
    _GEN_9
      ? _GEN_10
        | (_GEN_11 ? io_insts_pack_IF_2_inst[25] : io_insts_pack_IF_2_predict_jump)
      : io_insts_pack_IF_2_predict_jump;
  assign inst_pack_pd_2_pred_npc =
    _GEN_9
      ...
      : io_insts_pack_IF_2_pred_npc;
  wire        _GEN_12 = ~io_insts_pack_IF_3_pred_valid & io_insts_pack_IF_3_inst_valid;
  wire        _GEN_13 = jump_type_3 == 2'h1;
  wire        _GEN_14 = jump_type_3 == 2'h2;
  assign inst_pack_pd_3_predict_jump =
    _GEN_12
      ? _GEN_13
        | (_GEN_14 ? io_insts_pack_IF_3_inst[25] : io_insts_pack_IF_3_predict_jump)
      : io_insts_pack_IF_3_predict_jump;
  ...
  assign io_pred_fix =
    |{io_insts_pack_IF_3_inst_valid & ~io_insts_pack_IF_3_predict_jump
        & inst_pack_pd_3_predict_jump,
      pred_fix_2,
      pred_fix_1,
      pred_fix_0};
