...
module Prev_Decode(
  ...
  wire        pred_fix_0 = io_insts_pack_IF_0_inst_valid & _GEN_2;
  wire        pred_fix_1 = io_insts_pack_IF_1_inst_valid & _GEN_1;
  wire        pred_fix_2 = io_insts_pack_IF_2_inst_valid & _GEN_0;
  ...
  wire        _GEN_3 = io_insts_pack_IF_0_inst[31:30] == 2'h1;
    ...
    _GEN_3
      ? (io_insts_pack_IF_0_inst[29:26] == 4'h4 | io_insts_pack_IF_0_inst[29:26] == 4'h5
           ...
           : {io_insts_pack_IF_0_inst[29:26] > 4'h5
              ...
              1'h0})
      : 2'h0;
  wire        _GEN_4 = io_insts_pack_IF_1_inst[31:30] == 2'h1;
    ...
    _GEN_4
      ? (io_insts_pack_IF_1_inst[29:26] == 4'h4 | io_insts_pack_IF_1_inst[29:26] == 4'h5
           ...
           : {io_insts_pack_IF_1_inst[29:26] > 4'h5
              ...
              1'h0})
      : 2'h0;
  wire        _GEN_5 = io_insts_pack_IF_2_inst[31:30] == 2'h1;
    ...
    _GEN_5
      ? (io_insts_pack_IF_2_inst[29:26] == 4'h4 | io_insts_pack_IF_2_inst[29:26] == 4'h5
           ...
           : {io_insts_pack_IF_2_inst[29:26] > 4'h5
              ...
              1'h0})
      : 2'h0;
  wire        _GEN_6 = io_insts_pack_IF_3_inst[31:30] == 2'h1;
  ...
  always_comb begin
    casez (pred_index)
      2'b00:
        casez_tmp_0 = _GEN_3 & io_insts_pack_IF_0_inst[29:26] == 4'h5;
      2'b01:
        casez_tmp_0 = _GEN_4 & io_insts_pack_IF_1_inst[29:26] == 4'h5;
      2'b10:
        casez_tmp_0 = _GEN_5 & io_insts_pack_IF_2_inst[29:26] == 4'h5;
      default:
        casez_tmp_0 = _GEN_6 & io_insts_pack_IF_3_inst[29:26] == 4'h5;
    endcase
  end // always_comb
  always_comb begin
    casez (pred_index)
  ...
  wire        _GEN_7 = jump_type_0 == 2'h1;
  wire        _GEN_8 = jump_type_0 == 2'h2;
  assign _GEN_2 =
    _GEN_7
      ? ~io_insts_pack_IF_0_predict_jump
  ...
  wire        inst_pack_pd_0_predict_jump =
    io_insts_pack_IF_0_inst_valid
      ? _GEN_7
        | (_GEN_8 & ~io_insts_pack_IF_0_pred_valid
             ? io_insts_pack_IF_0_inst[25]
             : io_insts_pack_IF_0_predict_jump)
      : io_insts_pack_IF_0_predict_jump;
    ...
    io_insts_pack_IF_0_inst_valid
      ? (_GEN_7
           ...
           : _GEN_8
               ...
               : io_insts_pack_IF_0_pred_npc)
      : io_insts_pack_IF_0_pred_npc;
  wire        _GEN_9 = jump_type_1 == 2'h1;
  wire        _GEN_10 = jump_type_1 == 2'h2;
  assign _GEN_1 =
    _GEN_9
      ? ~io_insts_pack_IF_1_predict_jump
  ...
  wire        inst_pack_pd_1_predict_jump =
    io_insts_pack_IF_1_inst_valid
      ? _GEN_9
        | (_GEN_10 & ~io_insts_pack_IF_1_pred_valid
             ? io_insts_pack_IF_1_inst[25]
             : io_insts_pack_IF_1_predict_jump)
      : io_insts_pack_IF_1_predict_jump;
    ...
    io_insts_pack_IF_1_inst_valid
      ? (_GEN_9
           ...
           : _GEN_10
               ...
               : io_insts_pack_IF_1_pred_npc)
      : io_insts_pack_IF_1_pred_npc;
  wire        _GEN_11 = jump_type_2 == 2'h1;
  wire        _GEN_12 = jump_type_2 == 2'h2;
  assign _GEN_0 =
    _GEN_11
      ? ~io_insts_pack_IF_2_predict_jump
  ...
  wire        inst_pack_pd_2_predict_jump =
    io_insts_pack_IF_2_inst_valid
      ? _GEN_11
        | (_GEN_12 & ~io_insts_pack_IF_2_pred_valid
             ? io_insts_pack_IF_2_inst[25]
             : io_insts_pack_IF_2_predict_jump)
      : io_insts_pack_IF_2_predict_jump;
  ...
  assign io_insts_pack_PD_3_predict_jump =
    io_insts_pack_IF_3_inst_valid
      ? _GEN_13
        | (_GEN_14 & ~io_insts_pack_IF_3_pred_valid
             ? io_insts_pack_IF_3_inst[25]
             : io_insts_pack_IF_3_predict_jump)
      : io_insts_pack_IF_3_predict_jump;
  assign io_insts_pack_PD_3_pred_npc = inst_pack_pd_3_pred_npc;
  assign io_pred_fix =
    |{io_insts_pack_IF_3_inst_valid & _GEN, pred_fix_2, pred_fix_1, pred_fix_0};
