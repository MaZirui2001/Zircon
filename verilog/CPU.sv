...
module CPU(
  ...
  Order_Select sel3 (
    ...
    .io_inst_issue_inst_alu_op     (/* unused */),
  ...
  Order_Select sel4 (
    ...
    .io_inst_issue_inst_mem_type   (/* unused */),
