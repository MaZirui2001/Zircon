...
module Order_Issue_Queue(
  ...
  always_comb begin
    casez (casez_tmp_0)
      2'b00:
        casez_tmp_6 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_6 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_6 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_6 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_0)
  ...
  always_comb begin
    casez (casez_tmp_54)
      ...
      2'b01:
        casez_tmp_69 = io_prj_ready_1;
      2'b10:
        casez_tmp_69 = io_prj_ready_2;
      default:
        casez_tmp_69 = io_prj_ready_3;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_54)
      ...
      2'b01:
        casez_tmp_70 = io_prk_ready_1;
      2'b10:
        casez_tmp_70 = io_prk_ready_2;
      default:
  ...
  always_comb begin
    casez (_queue_4_prk_waked_T_1)
      ...
      2'b01:
        casez_tmp_71 = io_insts_disp_valid_1;
      2'b10:
        casez_tmp_71 = io_insts_disp_valid_2;
      default:
        casez_tmp_71 = io_insts_disp_valid_3;
    endcase
  end // always_comb
  always_comb begin
    casez (_queue_4_prk_waked_T_1)
      ...
      2'b01:
        casez_tmp_72 = io_insts_disp_index_1;
      2'b10:
        casez_tmp_72 = io_insts_disp_index_2;
      default:
        casez_tmp_72 = io_insts_disp_index_3;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
      2'b00:
        casez_tmp_73 = io_insts_dispatch_0_prj;
      2'b01:
        casez_tmp_73 = io_insts_dispatch_1_prj;
      2'b10:
        casez_tmp_73 = io_insts_dispatch_2_prj;
      default:
        casez_tmp_73 = io_insts_dispatch_3_prj;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
      2'b00:
        casez_tmp_74 = io_insts_dispatch_0_prk;
      2'b01:
        casez_tmp_74 = io_insts_dispatch_1_prk;
      2'b10:
        casez_tmp_74 = io_insts_dispatch_2_prk;
      default:
        casez_tmp_74 = io_insts_dispatch_3_prk;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
      2'b00:
        casez_tmp_75 = io_insts_dispatch_0_rd_valid;
      2'b01:
        casez_tmp_75 = io_insts_dispatch_1_rd_valid;
      2'b10:
        casez_tmp_75 = io_insts_dispatch_2_rd_valid;
      default:
        casez_tmp_75 = io_insts_dispatch_3_rd_valid;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
      2'b00:
        casez_tmp_76 = io_insts_dispatch_0_prd;
      2'b01:
        casez_tmp_76 = io_insts_dispatch_1_prd;
      2'b10:
        casez_tmp_76 = io_insts_dispatch_2_prd;
      default:
        casez_tmp_76 = io_insts_dispatch_3_prd;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
      2'b00:
        casez_tmp_77 = io_insts_dispatch_0_imm;
      2'b01:
        casez_tmp_77 = io_insts_dispatch_1_imm;
      2'b10:
        casez_tmp_77 = io_insts_dispatch_2_imm;
      default:
        casez_tmp_77 = io_insts_dispatch_3_imm;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
      2'b00:
        casez_tmp_78 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_78 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_78 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_78 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_72)
