...
module Order_Issue_Queue(
  ...
  input  [6:0]  io_wake_preg_0,
                ...
                io_wake_preg_3,
  input         io_issue_ack,
  output [6:0]  io_insts_issue_inst_prj,
  ...
  wire        full = _tail_pop_T >= 4'(4'h8 - {1'h0, insert_num});
  assign _tail_pop_T = 4'(tail - {3'h0, io_issue_ack});
  wire [1:0]  _queue_next_0_inst_T_3 = 2'(2'h0 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_0_inst_T_3)
      2'b00:
  ...
  wire [1:0]  _queue_next_1_prk_waked_T_4 = 2'(2'h1 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_1_prk_waked_T_4)
      2'b00:
  ...
  wire [1:0]  _queue_next_2_prk_waked_T_4 = 2'(2'h2 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_2_prk_waked_T_4)
      2'b00:
  ...
  always_comb begin
    casez (casez_tmp_22)
      2'b00:
        casez_tmp_29 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_29 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_29 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_29 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_22)
  ...
  wire [1:0]  _queue_next_3_prk_waked_T_4 = 2'(2'h3 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_3_prk_waked_T_4)
      2'b00:
  ...
  always_comb begin
    casez (casez_tmp_33)
      2'b00:
        casez_tmp_40 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_40 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_40 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_40 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_33)
  ...
  wire [1:0]  _queue_next_4_prk_waked_T_4 = 2'(2'h0 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_4_prk_waked_T_4)
      2'b00:
  ...
  always_comb begin
    casez (casez_tmp_44)
      2'b00:
        casez_tmp_51 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_51 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_51 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_51 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_44)
  ...
  wire [1:0]  _queue_next_5_prk_waked_T_4 = 2'(2'h1 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_5_prk_waked_T_4)
      2'b00:
  ...
  wire [1:0]  _queue_next_6_prk_waked_T_4 = 2'(2'h2 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_6_prk_waked_T_4)
      2'b00:
  ...
  always_comb begin
    casez (casez_tmp_66)
      2'b00:
        casez_tmp_73 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_73 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_73 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_73 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_66)
  ...
  wire [1:0]  _queue_next_7_prk_waked_T_4 = 2'(2'h3 - _tail_pop_T[1:0]);
  always_comb begin
    casez (_queue_next_7_prk_waked_T_4)
      2'b00:
  ...
  always_comb begin
    casez (casez_tmp_77)
      2'b00:
        casez_tmp_84 = io_insts_dispatch_0_alu_op;
      2'b01:
        casez_tmp_84 = io_insts_dispatch_1_alu_op;
      2'b10:
        casez_tmp_84 = io_insts_dispatch_2_alu_op;
      default:
        casez_tmp_84 = io_insts_dispatch_3_alu_op;
    endcase
  end // always_comb
  always_comb begin
    casez (casez_tmp_77)
  ...
  wire [6:0]  _queue_next_0_inst_T_7_prj = casez_tmp ? casez_tmp_1 : 7'h0;
  wire [6:0]  _queue_next_0_inst_T_7_prk = casez_tmp ? casez_tmp_2 : 7'h0;
  wire [6:0]  queue_next_0_inst_prj =
    (|_tail_pop_T)
      ? (io_issue_ack ? queue_1_inst_prj : queue_0_inst_prj)
      : _queue_next_0_inst_T_7_prj;
  wire [6:0]  queue_next_0_inst_prk =
    (|_tail_pop_T)
      ? (io_issue_ack ? queue_1_inst_prk : queue_0_inst_prk)
      : _queue_next_0_inst_T_7_prk;
  wire [6:0]  _queue_next_1_inst_T_7_prj = casez_tmp_10 ? casez_tmp_12 : 7'h0;
  wire [6:0]  _queue_next_1_inst_T_7_prk = casez_tmp_10 ? casez_tmp_13 : 7'h0;
  wire [6:0]  queue_next_1_inst_prj =
    (|(_tail_pop_T[3:1]))
      ? (io_issue_ack ? queue_2_inst_prj : queue_1_inst_prj)
      : _queue_next_1_inst_T_7_prj;
  wire [6:0]  queue_next_1_inst_prk =
    (|(_tail_pop_T[3:1]))
      ? (io_issue_ack ? queue_2_inst_prk : queue_1_inst_prk)
      : _queue_next_1_inst_T_7_prk;
  wire        _GEN = _tail_pop_T > 4'h2;
  wire [6:0]  _queue_next_2_inst_T_7_prj = casez_tmp_21 ? casez_tmp_23 : 7'h0;
  wire [6:0]  _queue_next_2_inst_T_7_prk = casez_tmp_21 ? casez_tmp_24 : 7'h0;
  wire [6:0]  queue_next_2_inst_prj =
    _GEN
      ? (io_issue_ack ? queue_3_inst_prj : queue_2_inst_prj)
      : _queue_next_2_inst_T_7_prj;
  wire [6:0]  queue_next_2_inst_prk =
    _GEN
      ? (io_issue_ack ? queue_3_inst_prk : queue_2_inst_prk)
      : _queue_next_2_inst_T_7_prk;
  wire [6:0]  _queue_next_3_inst_T_7_prj = casez_tmp_32 ? casez_tmp_34 : 7'h0;
  wire [6:0]  _queue_next_3_inst_T_7_prk = casez_tmp_32 ? casez_tmp_35 : 7'h0;
  wire [6:0]  queue_next_3_inst_prj =
    (|(_tail_pop_T[3:2]))
      ? (io_issue_ack ? queue_4_inst_prj : queue_3_inst_prj)
      : _queue_next_3_inst_T_7_prj;
  wire [6:0]  queue_next_3_inst_prk =
    (|(_tail_pop_T[3:2]))
      ? (io_issue_ack ? queue_4_inst_prk : queue_3_inst_prk)
      : _queue_next_3_inst_T_7_prk;
  wire        _GEN_0 = _tail_pop_T > 4'h4;
  wire [6:0]  _queue_next_4_inst_T_7_prj = casez_tmp_43 ? casez_tmp_45 : 7'h0;
  wire [6:0]  _queue_next_4_inst_T_7_prk = casez_tmp_43 ? casez_tmp_46 : 7'h0;
  wire [6:0]  queue_next_4_inst_prj =
    _GEN_0
      ? (io_issue_ack ? queue_5_inst_prj : queue_4_inst_prj)
      : _queue_next_4_inst_T_7_prj;
  wire [6:0]  queue_next_4_inst_prk =
    _GEN_0
      ? (io_issue_ack ? queue_5_inst_prk : queue_4_inst_prk)
      : _queue_next_4_inst_T_7_prk;
  wire        _GEN_1 = _tail_pop_T > 4'h5;
  wire [6:0]  _queue_next_5_inst_T_7_prj = casez_tmp_54 ? casez_tmp_56 : 7'h0;
  wire [6:0]  _queue_next_5_inst_T_7_prk = casez_tmp_54 ? casez_tmp_57 : 7'h0;
  wire [6:0]  queue_next_5_inst_prj =
    _GEN_1
      ? (io_issue_ack ? queue_6_inst_prj : queue_5_inst_prj)
      : _queue_next_5_inst_T_7_prj;
  wire [6:0]  queue_next_5_inst_prk =
    _GEN_1
      ? (io_issue_ack ? queue_6_inst_prk : queue_5_inst_prk)
      : _queue_next_5_inst_T_7_prk;
  wire        _GEN_2 = _tail_pop_T > 4'h6;
  wire [6:0]  _queue_next_6_inst_T_7_prj = casez_tmp_65 ? casez_tmp_67 : 7'h0;
  wire [6:0]  _queue_next_6_inst_T_7_prk = casez_tmp_65 ? casez_tmp_68 : 7'h0;
  wire [6:0]  queue_next_6_inst_prj =
    _GEN_2
      ? (io_issue_ack ? queue_7_inst_prj : queue_6_inst_prj)
      : _queue_next_6_inst_T_7_prj;
  wire [6:0]  queue_next_6_inst_prk =
    _GEN_2
      ? (io_issue_ack ? queue_7_inst_prk : queue_6_inst_prk)
      : _queue_next_6_inst_T_7_prk;
  wire [6:0]  _queue_next_7_inst_T_7_prj = casez_tmp_76 ? casez_tmp_78 : 7'h0;
  wire [6:0]  _queue_next_7_inst_T_7_prk = casez_tmp_76 ? casez_tmp_79 : 7'h0;
  wire [6:0]  queue_next_7_inst_prj =
    _tail_pop_T[3]
      ? (io_issue_ack ? 7'h0 : queue_7_inst_prj)
      : _queue_next_7_inst_T_7_prj;
  wire [6:0]  queue_next_7_inst_prk =
    _tail_pop_T[3]
      ? (io_issue_ack ? 7'h0 : queue_7_inst_prk)
      : _queue_next_7_inst_T_7_prk;
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (|_tail_pop_T) begin
        ...
        queue_0_inst_prj <= _queue_next_0_inst_T_7_prj;
        queue_0_inst_prk <= _queue_next_0_inst_T_7_prk;
      ...
      if (|(_tail_pop_T[3:1])) begin
        ...
        queue_1_inst_prj <= _queue_next_1_inst_T_7_prj;
        queue_1_inst_prk <= _queue_next_1_inst_T_7_prk;
        ...
        queue_1_inst_alu_op <= casez_tmp_10 ? casez_tmp_18 : 5'h0;
      end
      queue_1_prj_waked <=
        ((|(_tail_pop_T[3:1]))
      ...
      if (_GEN) begin
        ...
        queue_2_inst_prj <= _queue_next_2_inst_T_7_prj;
        queue_2_inst_prk <= _queue_next_2_inst_T_7_prk;
        ...
        queue_2_inst_alu_op <= casez_tmp_21 ? casez_tmp_29 : 5'h0;
      end
      queue_2_prj_waked <=
        (_GEN
      ...
      if (|(_tail_pop_T[3:2])) begin
        ...
        queue_3_inst_prj <= _queue_next_3_inst_T_7_prj;
        queue_3_inst_prk <= _queue_next_3_inst_T_7_prk;
        ...
        queue_3_inst_alu_op <= casez_tmp_32 ? casez_tmp_40 : 5'h0;
      end
      queue_3_prj_waked <=
        ((|(_tail_pop_T[3:2]))
      ...
      if (_GEN_0) begin
        ...
        queue_4_inst_prj <= _queue_next_4_inst_T_7_prj;
        queue_4_inst_prk <= _queue_next_4_inst_T_7_prk;
        ...
        queue_4_inst_alu_op <= casez_tmp_43 ? casez_tmp_51 : 5'h0;
      end
      queue_4_prj_waked <=
        (_GEN_0
      ...
      if (_GEN_1) begin
        ...
        queue_5_inst_prj <= _queue_next_5_inst_T_7_prj;
        queue_5_inst_prk <= _queue_next_5_inst_T_7_prk;
        ...
        queue_5_inst_alu_op <= casez_tmp_54 ? casez_tmp_62 : 5'h0;
      end
      queue_5_prj_waked <=
        (_GEN_1
      ...
      if (_GEN_2) begin
        ...
        queue_6_inst_prj <= _queue_next_6_inst_T_7_prj;
        queue_6_inst_prk <= _queue_next_6_inst_T_7_prk;
        ...
        queue_6_inst_alu_op <= casez_tmp_65 ? casez_tmp_73 : 5'h0;
      end
      queue_6_prj_waked <=
        (_GEN_2
      ...
      if (_tail_pop_T[3]) begin
        ...
        queue_7_inst_prj <= _queue_next_7_inst_T_7_prj;
        queue_7_inst_prk <= _queue_next_7_inst_T_7_prk;
        ...
        queue_7_inst_alu_op <= casez_tmp_76 ? casez_tmp_84 : 5'h0;
      end
      queue_7_prj_waked <=
      ...
      if (io_flush)
        ...
        tail <= 4'(_tail_pop_T + {1'h0, full ? 3'h0 : insert_num});
    end
  end // always @(posedge)
