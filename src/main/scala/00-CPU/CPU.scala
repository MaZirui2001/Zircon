...
class CPU extends Module {
    ...
    ls_ex_mem_reg.io.exception_EX       := exception_ls.io.exception_ls
    ...
    ew_reg3.io.md_out_EX            := Mux(!md_ex2_ex3_reg.io.inst_pack_EX2.alu_op(4), mdu.io.mul_out, mdu.io.div_out)
