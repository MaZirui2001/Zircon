...
object IS_RF_Reg {
    def apply(_inst_pack_DP: inst_pack_DP_t, _inst_valid: Bool, _flush: Bool, _stall: Bool): IS_RF_Reg = {
        ...
        is_rf_reg.io.inst_pack_IS.rj            := _inst_pack_DP.rj
        is_rf_reg.io.inst_pack_IS.rj_valid      := _inst_pack_DP.rj_valid
        is_rf_reg.io.inst_pack_IS.prj           := _inst_pack_DP.prj
        is_rf_reg.io.inst_pack_IS.rk            := _inst_pack_DP.rk
        is_rf_reg.io.inst_pack_IS.rk_valid      := _inst_pack_DP.rk_valid
